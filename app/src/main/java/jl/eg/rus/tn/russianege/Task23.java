...
public class Task23 extends AppCompatActivity {
    ...
    static final String[] answer1 =
            {
                    ...
                    "1) В предложениях 18—19 представлено рассуждение.",
    ...
    static final String[] answer4 =
            {
                    ...
                    "4) В предложениях 38−40 содержится объяснение того, о чём говорится в предложении 36.",
                    ...
                    "4) В предложениях 26—27 содержится обоснование высказанного в предложении 25 суждения.",
    ...
    static final String[] answer5 =
            {
                    "5) В предложениях 25—27 содержится описание.",
    ...
    static final String[] true_answers = {"134","45","123","234","1234","25","14","25","123","124",""};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Какие из перечисленных утверждений являются верными?Укажите номера ответов,нажав на них.");
        if (index == 1||index ==4 || index == 5 ||index == 6||index == 8){
            title.setText("Какие из перечисленных утверждений являются ошибочными?Укажите номера ответов,нажав на них.");
        }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Task23.this,TasksChoose.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (person_answer.equalsIgnoreCase(index_answer)){
                    result1 = "true";
                    Intent intent = new Intent(Task23.this, Result23.class);
                    intent.putExtra("result23", result1);
                    startActivity(intent);
                }
                else
                {
