...
public class Task22 extends AppCompatActivity {
    ...
    static final String[] answer1 =
            {
                    ...
                    "1) Савушкин каждое утро ходил в лес в поисках антилопы.",
                    "1) Люди готовы платить за цветы немалые деньги.",
                    "1) Человечество ограничено в своём представлении о мире.",
                    "1) Родителей современных подростков более всего беспокоит то, что их дети целые дни проводят у телевизоров.",
                    ...
                    "1) Чтобы сохранить на протяжении жизни свою индивидуальность и врожденную талантливость, нужно обладать духовной силой.",
                    "",
                    "",
    ...
    static final String[] answer2 =
            {
                    ...
                    "2) Если взять почти у каждого писателя полное собрание его сочинений и оставить четверть написанного,\nлитература очень много потеряет.",
                    "2) Савушкин увидел антилопу с детёнышем и не стал в неё стрелять.",
                    ...
                    "2) Родители современных подростков даже при большом желании не сумеют научиться ориентироваться в виртуальном пространстве.",
    ...
    static final String[] answer3 =
            {
                    ...
                    "3) Образованный человек не должен пользоваться Интернетом.",
    ...
    static final String[] answer4 =
            {
                    ...
                    "4) Пастух Гришка собирался охотиться на антилопу и исходил всю лощину в её поисках.",
                    ...
                    "4) Современные подростки общаются сегодня через Интернет.",
    ...
    static final String[] answer5 =
            {
                    ...
                    "5) Отец накрыл голову дочери покрывалом, чтобы не пекло солнце.",
                    ...
                    "5) Визит к специалисту необходим лишь в том случае, если у подростка начинают проявляться признаки интернет-зависимости.",
                    "5) Канцелярит—злокачественная болезнь нашей речи.",
                    "5) Не во всех делах можно быть художником или артистом",
    ...
    static final String[] true_answers = {"345","235","34","145","135","45","45","123","234","124",""};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Какие из высказываний соответствуют содержанию текста?Укажите номера ответов,нажав на них.");
        if (index == 4||index == 8){
            title.setText("Какие утверждения не соответствуют содержанию текста?Укажите номера ответов,нажав на них.");
        }
        if (index == 6){
            title.setText("Какие утверждения противоречат содержанию текста?Укажите номера ответов,нажав на них.");
        }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Task22.this,TasksChoose.class);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (person_answer.equalsIgnoreCase(index_answer)){
                    result1 = "true";
                    Intent intent = new Intent(Task22.this, Result22.class);
                    intent.putExtra("result22", result1);
                    startActivity(intent);
                }
                else
                {
