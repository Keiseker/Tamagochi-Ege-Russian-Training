...
public class Theory_19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.table19);
        //важные слова
        ...
        //вставка теории
        main.setText("Задание 19");
        title.setText("Алгоритм решения задания");
      ...
      links.setText("Если остались вопросы, советую посмотреть эти видеоролики :)\n https://www.youtube.com/watch?v=304tWvcfa0Y\n https://www.youtube.com/watch?v=sakRGdWyZwE&t=4s ");
        ...
        task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_19.this, Task19.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_19.this, Theory_20.class);
                    startActivity(intent);
                    finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_19.this, Theory_18.class);
                    startActivity(intent);
                    finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_19.this, TheoryChoose.class);
                    startActivity(intent);
                    finish();
