...
public class Theory_16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.task16);
        //важные слова
        ...
        title.setText("Роль союза \"и\"");
        expln.setVisibility(View.GONE);
        title1.setVisibility(View.GONE);
        title2.setVisibility(View.GONE);
        expln1.setVisibility(View.GONE);
        expln2.setVisibility(View.GONE);
        main.setText("Задание 16");
        links.setText("Если остались вопросы, советую посмотреть эти видеоролики :)\n https://www.youtube.com/watch?v=lyMynybAhQ8\n https://www.youtube.com/watch?v=navOxicpOQM");
        //Кнопка к заданиям
        task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_16.this, Task16.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_16.this, Theory_17.class);
                    startActivity(intent);
                    finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_16.this, Theory_15.class);
                    startActivity(intent);
                    finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_16.this, TheoryChoose.class);
                    startActivity(intent);
                    finish();
