...
public class Theory_14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.task14);
        //важные слова
        ...
        main.setText("Задание 14");
        title.setText("Слитное, дефисное, раздельное написание слов");
        links.setText("Если остались вопросы, советую посмотреть эти видеоролики :)\n https://www.youtube.com/watch?v=6A9bmTSduig");
        //Кнопка к заданиям
        task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_14.this, Task14.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_14.this, Theory_15.class);
                    startActivity(intent);
                    finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_14.this, Theory_13.class);
                    startActivity(intent);
                    finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_14.this, TheoryChoose.class);
                    startActivity(intent);
                    finish();
