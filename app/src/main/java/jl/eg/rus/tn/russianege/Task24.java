...
public class Task24 extends AppCompatActivity {

    TextView title,show,hide,text,a1;
    Button btn,back,reset;
    String index_answer,person_answer,result;

    static final String[] answer1 =
            {
                    "\t\t(14)Но наряду с такими \"существователями\" есть и те, кто напряжённо ищет истину.(15)Как педагогу, мне довелось встречать молодых людей, жаждущих ясного и чёткого ответа на вопрос о высших ценностях жизни.",
                    ...
                    "\t\t(28)То ли ещё будет.\n\t\t(29)Нам стоит поучиться у детей.(30)Мне тоже в своё время пришлось пройти через период раздражения и недовольства.",
                    "\t\t(10)Статья его так и называлась — «Канцелярит», и прозвучала она поистине как SOS.(11)He решаюсь сказать, что то был глас вопиющего в пустыне: к счастью, есть рыцари, которые, не щадя сил, сражаются за честь Слова.(12)Но, увы, надо посмотреть правде в глаза: канцелярит не сдаётся, он наступает, ширится.(13)Это окаянный и зловредный недуг нашей речи.(14)Быстро разрастаются чужеродные, губительные клетки — постылые штампы, которые не несут ни мысли, ни чувства, ни на грош информации, а лишь забивают и угнетают живое, полезное ядро.",
    ...
    static final String[] true_answers = {"вопросответ","хлопотполонрот","снаружиизнутри","подсамымносом","некрасивойбезвкусной","арсенал","раздражениенедовольство","глас","устарелымнесовременным","бездарныхталантливых",""};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tasks_24_25);
        ...
        if(index == 1||index==3||index==10){
            title.setText("Из данного(-ых) предложения(-ий) выпишите антонимы.Без пробелов и запятых.");
        }
        if (index == 2||index ==4){
            title.setText("Из данного(-ых) предложения(-ий) выпишите фразеологизмы.Без пробелов и запятых.");
        }
        if(index == 5){
            title.setText("Выпишите слова, которые являются контекстными синонимами в данных предложениях.");
        }
        if(index == 7||index == 9){
            title.setText("Выпишите слова, которые являются синонимами в данных предложениях.");
        }
        if(index == 8){
            title.setText("Выпишите существительное,которое является устаревшим словом в данных предложениях.");
        }
        if(index == 6){
            title.setText("Из данных предложений выпишите слово, употреблённое в переносном значении, которое в одном из прямых значений обозначает «склад оружия»");
        }
        ...
        //кнопка назад сверху
        back = findViewById(R.id.backtotask2425);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {

                    Intent intent = new Intent(Task24.this,TasksChoose.class);
            ...
            public void onClick(View v) {
                ...
                if (index == 2){
                    if (person_answer.equalsIgnoreCase(index_answer)){
                        result = "true";
                        Intent intent = new Intent(Task24.this, Result24.class);
                        intent.putExtra("result24", result);
                        startActivity(intent);
                    }//if 3
                    if (person_answer.equalsIgnoreCase("сдругойстороны")){
                        result = "true";
                        Intent intent = new Intent(Task24.this, Result24.class);
                        intent.putExtra("result24", result);
                        startActivity(intent);
                    }//if 3
                    if (person_answer.equalsIgnoreCase("надосуге.")){
                        result = "true";
                        Intent intent = new Intent(Task24.this, Result24.class);
                        intent.putExtra("result24", result);
                        startActivity(intent);
                    }//if 3
                    if (person_answer.equalsIgnoreCase("чтоназывается")){
                        result = "true";
                        Intent intent = new Intent(Task24.this, Result24.class);
                        intent.putExtra("result24", result);
                        startActivity(intent);
