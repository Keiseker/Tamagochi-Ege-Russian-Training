...
public class Theory_23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.task23);
        //важные слова
        ...
        title.setText("Типы речи");
        main.setText("Задание 23");
        ...
        task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_23.this, Task23.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_23.this, Theory_24.class);
                    startActivity(intent);
                    finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_23.this, Theory_22.class);
                    startActivity(intent);
                    finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_23.this, TheoryChoose.class);
                    startActivity(intent);
                    finish();
