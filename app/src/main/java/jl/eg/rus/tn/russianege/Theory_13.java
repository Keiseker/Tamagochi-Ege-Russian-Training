...
public class Theory_13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setImageResource(R.drawable.task13);
        //важные слова
        ...
        main.setText("Задание 13");
        title.setText("Правописание НЕ И НИ");
        links.setText("Если остались вопросы, советую посмотреть эти видеоролики :)\n https://www.youtube.com/watch?v=HR9keNkGHkc\n https://www.youtube.com/watch?v=DzJ6zAO4Ty0\n https://www.youtube.com/watch?v=8bAhMsIwnP4");
        //Кнопка к заданиям
        task.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_13.this, Task13.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_13.this, Theory_14.class);
                    startActivity(intent);
                    finish();
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_13.this, Theory_12.class);
                    startActivity(intent);
                    finish();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(Theory_13.this, TheoryChoose.class);
                    startActivity(intent);
                    finish();
